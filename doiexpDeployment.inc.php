...
import('plugins.importexport.doiexp.lib.pkp.plugins.importexport.native.PKPdoiexpImportExportDeployment');

class doiexpDeployment extends PKPNativeImportExportDeployment {
	/**
	 * Constructor
