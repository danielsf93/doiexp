...
import('plugins.importexport.doiexp.lib.pkp.classes.plugins.importexport.PKPaImportExportDeployment');

class PKPdoiexpImportExportDeployment extends PKPaImportExportDeployment {
	/**
	 * Constructor
